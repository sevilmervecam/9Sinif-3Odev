...
Yukarıdaki örneği kullanarak **kendi ölçümlerinizle** bir tablo oluşturun (Aşağıda yeni bir tablo oluşturun ve yukarıdaki tabloya 3-4 tane kendi ölçümünü ekleyiniz.) 
 FRAME|ZAMAN(s)|KONUM(m)
 -----|--------|-------
 16|0,15|0,025
 28|0,35|0,049
...
Havayı değil de belki direk sürtünmeyi ihmal etseydik olabilirdi çünkü cisme etki eden tek sürtünme çeşidi hava sürtünmesi değil.

c) Video'daki cismin atılış hızı farklı olsaydı (diğer herşey aynı, kütle, yüzey, vb. Hava sürtünmesini ihmal edin), sizce formülde hangi terimler değişecekti? (a, b veya c) Bu soru hakkında pek bir fikrim yok ama b ve c belki?
...
1) Kendi aldığınız verileri kullanarak **ortalama hız-zaman** grafiğini Google çiziniz. [Buraya](https://docs.google.com/spreadsheets/d/15XoiQU_HQ6PeHDs9UvUsj2zyekGRMfet-s0xCvPaBx0/edit?usp=sharing) link veriniz.
...
3) İvme'yi ne buldunuz? İvme= 1,05x + -2,92'den -1,87 Bu ivme değerini kullanarak 1kg'lık cisim ile yüzey arasındaki kinetik sürtünme katsayısını bulunuz. Kinetik Sürtünme Katsayısı= 0,187
...
Yardım:
* Düzgün ivmelenen bir cisim için alınan yol formülü x = (ilk hız+ son hız)/2*t, burdan cismin ilk hızını bulunuz. 2,166 m/s
